...
<link rel="stylesheet" href="cssheader.css" type="text/css" media="screen" />
...
<div id="body-container">
	...
	<div id="header-container">
		<header class="cf">
			...
			<!-- liens facebook etc 
			<a id="plus" href="#"><img class="plus" src="images/facebook.png"/>.</a>
			<a id="plus" href="#"><img class="plus" src="images/twitter.png"/>.</a>
			<a id="plus" href="#"><img class="plus" src=""/>.</a>
			<a id="plus" href="#"><img class="plus" src=""/>.</a>
			<a id="plus" href="#"><img class="plus" src=""/>.</a>
			-->
