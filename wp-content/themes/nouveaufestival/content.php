...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<?php endif; 
				...
				$annee = get_post_meta($post->ID, 'Date', true);
		...
		if (false === empty($realisateur) || false === empty($acteurs) || false === empty($annee) || false === empty($genre) || false === empty($pays) || false === empty($duree) || false === empty($langue) ): ?>
		 	<div class="champs-persos">
		 		<span class="champs-persos-titre">Détails :</span>

              <?php
				             if(false === empty($realisateur)): ?>
				             ...
				             <span class="champs-persos-item">
				                   <i class=”champs-persos-label”>Acteurs: </i>
				                   <?php echo $acteurs ?></span>
				             <?php endif; ?>

				             <?php if(false === empty($annee)): ?>
				             <span class="champs-persos-item">
				                   <i class=”champs-persos-label”>Date : </i>
				                   <?php echo $annee ?></span>
				             <?php endif; ?>
